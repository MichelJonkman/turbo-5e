...
50 gp, ½ lb.  
This potion's red liquid glimmers when agitated. As an **action** you may drink to potion to regain 1 spent **Hit Die** and **10** **hit points**. Alternatively you may use a **bonus action** to drink the potion and regain 1 spent **Hit Die** and **2d4 + 2 hit points**.
...
::: details Future idea for feat tree
...
A creature you touch regains a number of **hit points** equal to 1d8 + your spellcasting ability modifier. In addition, the touched creature may choose to spend and roll one of its unspent **Hit Dice** and regain a number of hit points equal to the roll plus its **Constitution** modifier for each **Hit Die** spent.

This spell has no effect on undead or constructs.

***At Higher Levels.*** When you cast this spell using a spell slot of 2nd level or higher, the healing increases by 1d8 for each slot level above 1st, and the number of **Hit Dice** that can be spent and added to the healing roll increases by one for each slot above 1nd.
***
### Healing Word
*1st-level evocation*  
...
**Components**: V  
**Duration**: Instantaneous  
A creature of your choice that you can see within range regains hit points equal to 1d4 + your spellcasting ability modifier. In addition, the touched creature may choose to spend and roll one of its unspent **Hit Dice** and regain a number of hit points equal to the number rolled.

This spell has no effect on undead or constructs.

***At Higher Levels.*** When you cast this spell using a spell slot of 2nd level or higher, the healing increases by 1d4 for each slot level above 1st, and the number of **Hit Dice** that can be spent and added to the healing roll increases by one for each slot above 1nd.
***
### Prayer of Healing
*2nd-level evocation*  
...
**Components**: V  
**Duration**: Instantaneous  
Up to six creatures of your choice that you can see within range each regain hit points equal to 2d8 + your spellcasting ability modifier. In addition, the chosen creatures may choose to spend and roll one of their unspent **Hit Dice** and regain a number of hit points equal to the roll plus its **Constitution** modifier for each **Hit Die** spent.

This spell has no effect on undead or constructs.

***At Higher Levels.*** When you cast this spell using a spell slot of 3rd level or higher, the healing increases by 1d8 for each slot level above 2nd, and the number of **Hit Dice** that can be spent and added to the healing roll increases by one for each 2 slots above 2nd.
***
### Lesser Restoration
...
**Components**: V  
**Duration**: Instantaneous  
As you call out words of restoration, up to six creatures of your choice that you can see within range regain hit points equal to 1d4 + your spellcasting ability modifier. This spell has no effect on undead or constructs. In addition, the touched creature may choose to spend and roll one of its unspent **Hit Dice** and regain a number of hit points equal to the number rolled.
